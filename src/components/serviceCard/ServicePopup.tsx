...
const ServicePopup: React.FC<ServicePopupProps> = ({ onClose }) => {
    ...
    return (
        <motion.div
            className="container mx-auto flex items-center justify-end fixed top-1/5 right-0 bottom-0 z-50 px-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
        ...
        >
            ...
            >
                ...
                <div className="p-8">
                    <h2 id="popup-title" className="text-2xl lg:text-3xl font-bold text-black/80 mb-4 text-center">
                        Мои работы
                    </h2>
                    <p className="text-lg text-gray-600 mb-6 text-center">
                        Советы, истории и фото-видео моих работ — не пропустите ничего важного, переходите и подписывайтесь в мою группу!
                    </p>
