        ...
        <div ref={sectionRef} className="w-full ">
            ...
            <div className="mt-6 text-center">
                <button
                    ...
                    className="animate-child inline-flex items-center justify-center px-6 py-3 border border-mint-500 text-mint-500 font-semibold rounded-full hover:bg-mint-500 hover:text-white transition-all duration-300 transform hover:scale-105 hover:shadow-lg group"
