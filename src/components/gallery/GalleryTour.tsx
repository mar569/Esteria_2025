            ...
            <div className="rounded-3xl p-8 lg:p-12 max-w-4xl mx-auto card">
                ...
                >
                    <a
                        ...
                        className="inline-flex items-center justify-center gap-2 px-6 py-3 border border-mint-500 text-mint-500 font-semibold rounded-full hover:bg-mint-500 hover:text-white transition-all duration-300 transform hover:scale-105 hover:shadow-lg group"
                    >
                        <Phone size={18} />
                        Позвонить сейчас
                    </a>
